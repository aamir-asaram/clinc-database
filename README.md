# clinc-database<!-- TABLE OF CONTENTS -->
...
**Clinic Database** is a project that involves creation of a database and adding a table with various elements based on a schema diagram.
...
```sh
  cd my-folder
  git clone https://github.com/aamir-asaram/clinic-database.git
```
...
I would like to thank my partners and reviewers of the code for helping make the site better as well as Microverse for providing the [schema](https://github.com/microverseinc/curriculum-databases/blob/main/db-structure/images/clinic_diagram.png) for this project.
